    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-phoenix-cyan/20 to-blue-500/20 border border-phoenix-cyan/30 flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl font-bold text-phoenix-cyan">EK</span>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-phoenix-cyan hover:text-phoenix-cyan/80 transition-colors"
            >
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-phoenix-cyan/20 to-blue-500/20 border border-phoenix-cyan/30 flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl font-bold text-phoenix-cyan">TC</span>
            </div>
